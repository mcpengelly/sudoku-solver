...
describe('sudoku solver', function(){
	...
	describe('function checkValue', function(){
		it('should check if the value can be input into the selected square', function(){
	...
	describe('function solvePuzzle', function(){
